...
use hal::serial;
use nb;
use stm32f40x::{USART1, USART2, USART3, UART4, UART5, USART6};
use void::Void;
/*
	PA0-WKUP	UART4_TX	
	PA1	UART4_RX	
...
use gpio::gpioa::{PA0, PA1, PA2, PA3, PA9, PA10};
use gpio::gpiob::{PB10, PB11};
use gpio::gpioc::{PC6, PC7, PC10, PC11, PC12};
...
hal! {
    ...
    USART2: (usart2, APB1, usart2en, uart2rst, pclk2),
    USART3: (usart3, APB1, usart3en, uart3rst, pclk2),
    UART4: (uart4, APB1, uart4en, uart4rst, pclk2),
    UART5: (uart5, APB1, uart5en, uart5rst, pclk2),
